...
const RemoveObject = () => {
  ...
  const [object, setObject] = useState('') // for the user input (about image object)
  ...
  const onSubmitHandler = async(e) =>{
    ...
    try {
      ...
      if(data.success){
        // setContent(data.content) // chat gpt bola :
        setContent(data.image) // ✅ Because backend now returns: { success: true, image: "..." }
  ...
  return (
    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
          ...
          <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
            ...
            rounded-md border border-gray-300' placeholder='e.g., watch or spoon , only sigle object name' required />
